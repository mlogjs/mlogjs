...
declare global {
  interface LiquidHolder extends WithSymbols<
    {
  ...
  interface ItemHolder extends WithSymbols<
    {
  ...
  interface PowerHolder extends WithSymbols<{
    ...
    /**
     * How much power is being generated in the power net that is this building
     * is a part of.
     */
    readonly powerNetIn: number;
    /**
     * How much power is being spent in the power net that is this building is a
     * part of.
     */
    readonly powerNetOut: number;
  }> {}

  interface Shooting extends WithSymbols<{
  ...
  interface WithHealth extends WithSymbols<{
    readonly health: number;
    readonly maxHealth: number;
    readonly dead: boolean;
  }> {}

  interface Heatable extends WithSymbols<{
    /**
     * Can mean:
     *
  ...
  interface WithShield extends WithSymbols<{
    /**
  ...
  interface WithEffiency extends WithSymbols<{
    readonly efficiency: number;
  }> {}

  interface WithProgress extends WithSymbols<{
    /**
  ...
  interface WithTimescale extends WithSymbols<{
    /**
  ...
  interface Rotatable extends WithSymbols<{
    /**
  ...
  interface Spaced extends WithSymbols<{
    readonly x: number;
    readonly y: number;
    readonly size: number;
  }> {}

  interface Ranged extends WithSymbols<{
    readonly range: number;
  }> {}

  interface Boosted extends WithSymbols<{
    readonly boosting: boolean;
  }> {}

  interface Mining extends WithSymbols<{
    readonly mineX: number;
    readonly mineY: number;
    readonly mining: number;
  }> {}

  interface Typed<T extends symbol = symbol> extends WithSymbols<{
    readonly type: T;
  }> {}
  interface Flagged extends WithSymbols<{
    readonly flag: number;
  }> {}

  interface Controlled extends WithSymbols<{
    /**
     ...
     * If `this` is an unit:
     *
     * - `ControlKind.ctrlProcessor` if `this` is being controlled by a processor.
  ...
  interface WithController extends WithSymbols<{
    /**
  ...
  interface Nameable extends WithSymbols<{
    /** The name of the player controlling this unit. */
    readonly name?: string;
  }> {}

  interface PayloadHolder extends WithSymbols<
    {
  ...
  interface WithEnable extends WithSymbols<{
  ...
  interface WithSpeed extends WithSymbols<{
    /** The base movement speed of this unit. Measured in tiles/second. */
    readonly speed: number;
  }> {}

  interface WithColor extends WithSymbols<{
    /**
     * Can be:
     *
  ...
  interface WithTeam extends WithSymbols<{
    /** The team id of `this`. */
    readonly team: number;
  }> {}

  interface WithArmor extends WithSymbols<{
    readonly armor: number;
  }> {}

  interface WithCamera extends WithSymbols<{
  ...
  interface WithDisplay extends WithSymbols<{
    readonly displayHeight: number;
    readonly displayWidth: number;
  }> {}

  interface WithMemory extends WithSymbols<{
    readonly memoryCapacity: number;
  }> {}

  interface WithBufferSize extends WithSymbols<{
    readonly bufferSize: number;
  }> {}

  interface WithSolid extends WithSymbols<{
    readonly solid: boolean;
  }> {}

  interface WithVelocity extends WithSymbols<{
    readonly velocityX: number;
    readonly velocityY: number;
  }> {}

  interface WithOperations extends WithSymbols<{
