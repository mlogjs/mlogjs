  ...
  constructor() {
    const data = createOverloadNamespace({
      overloads: {
        ...
        spawn: { args: ["x", "y"] },
        trail: { args: ["x", "y", "color", "size"], named: "options" },
        breakPop: { args: ["x", "y", "color", "size"], named: "options" },
        smokeCloud: { args: ["x", "y", "color"] },
        vapor: { args: ["x", "y", "color"] },
        hit: { args: ["x", "y", "color"] },
        hitSquare: { args: ["x", "y", "color"] },
        shootSmall: { args: ["x", "y", "color", "rotation"], named: "options" },
        shootBig: { args: ["x", "y", "color", "rotation"], named: "options" },
        smokeSmall: { args: ["x", "y", "rotation"] },
        smokeBig: { args: ["x", "y", "rotation"] },
        smokeColor: { args: ["x", "y", "color", "rotation"], named: "options" },
        smokeSquare: {
          args: ["x", "y", "color", "rotation"],
          named: "options",
        },
        smokeSquareBig: {
          args: ["x", "y", "color", "rotation"],
        ...
        sparkShoot: { args: ["x", "y", "color", "rotation"], named: "options" },
        sparkShootBig: {
          args: ["x", "y", "color", "rotation"],
          named: "options",
        },
        ...
        lightBlock: { args: ["x", "y", "color", "size"], named: "options" },
        explosion: { args: ["x", "y", "size"] },
        smokePuff: { args: ["x", "y", "color"] },
        sparkExplosion: { args: ["x", "y", "color"] },
        crossExplosion: { args: ["x", "y", "color", "size"], named: "options" },
